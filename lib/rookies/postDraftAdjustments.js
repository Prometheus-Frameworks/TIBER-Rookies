...
export function applyPostDraftAdjustments({ preDraftGrade, draftResult, hasDraftOutcome = false }) {
  if (!hasDraftOutcome) {
    return {
      preDraftGrade: Number.isFinite(preDraftGrade) ? preDraftGrade : null,
      postDraftAdjustedGrade: null,
      postDraftDelta: null,
      postDraftTag: 'post_draft_pending',
      landingSpotNote: null,
