...
export function mapRookieToCard({ alphaPlayer, combineRow, productionRow, draftRow, statsRow, pprRow, dynastyRow, trendRow, rank }) {
  ...
  const pprProjection = pprRow
    ? {
        ...
        confidence: pprRow.projection_confidence ?? null,
        volatility: pprRow.projection_volatility ?? null,
        thesis: pprRow.projection_thesis ?? null,
        method: pprRow.projection_method ?? 'alpha_band_v1',
      }
    : null;
