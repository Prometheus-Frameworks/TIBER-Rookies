...
def build_candidates_for_entry(entry: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        candidate.update(
            {
                ...
                "positive_signal_tags": [
                    "heavy_te_personnel_meta",
                    "13_personnel_efficiency_signal",
                ],
                "risk_tags": [
                ...
                "context_tags": [
                    "wr_target_consolidation_possible",
                    "two_wr_set_target_focus",
                ],
    ...
    if "post_draft_watchlist" in entry_id:
        ...
        stock_down = _split_entities(_extract_segment(entry["entry_text"], "Stock down:", "Backfields:"))
        backfields = _split_entities(_extract_segment(entry["entry_text"], "Backfields:", "Treat this"))
        ...
        candidate.update(
            {
                ...
                "related_entities": stock_up + stock_down + backfields,
